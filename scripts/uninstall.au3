...
#AutoIt3Wrapper_Outfile=.\walkner-icpo-uninstall.exe
#AutoIt3Wrapper_Res_Description=Odinstaluj aplikację ICPO.
#AutoIt3Wrapper_Res_Fileversion=1.0.0.0
#AutoIt3Wrapper_Res_ProductVersion=0.0.0
#AutoIt3Wrapper_Res_LegalCopyright=Copyright © 2014 miracle.systems
#AutoIt3Wrapper_Res_Language=1045
#AutoIt3Wrapper_Res_Field=OriginalFilename|walkner-icpo-uninstall.exe
#AutoIt3Wrapper_Res_Field=FileDescription|Plik usuwający aplikację ICPO.
#AutoIt3Wrapper_Res_Field=ProductName|Walkner ICPO
#AutoIt3Wrapper_Res_Field=CompanyName|Miracle Systems Łukasz Walukiewicz
#AutoIt3Wrapper_Res_Field=HomePage|http://miracle.systems/
#AutoIt3Wrapper_Res_Field=E-mail|lukasz@miracle.systems
...
FileDelete(@StartupDir & "\Walkner ICPO.lnk")
...
If $removeData Then
  ...
  FileDelete($ROOT_DIR & "\data\" & $SERVICE_NAME & "-input.json")
  FileDelete($ROOT_DIR & "\data\" & $SERVICE_NAME & "-output.xml")
  DirRemove($ROOT_DIR & "\data\" & $SERVICE_NAME & "-storage", 1)
EndIf
