...
var DEST_APP = DEST_INSTALLER + '/bin/walkner-icpo';
  ...
  installer: {
    files: [
      ...
      },
      {
        ...
        dest: DEST_INSTALLER + '/docs/walkner-icpo-install-guide.pl.pdf'
      },
      {
        src: './docs/license.pl.pdf',
        dest: DEST_INSTALLER + '/docs/walkner-icpo-license.pl.pdf'
      },
      {
        src: './docs/user-guide.pl.pdf',
        dest: DEST_INSTALLER + '/docs/walkner-icpo-user-guide.pl.pdf'
      },
      {
        src: './data/.keep',
        dest: DEST_INSTALLER + '/data/walkner-icpo-storage/.keep'
      },
      {
        src: './data/input.json',
        dest: DEST_INSTALLER + '/data/walkner-icpo-input.json'
      },
      {
        src: './data/.keep',
      ...
      {
        src: './data/config.js',
        dest: DEST_INSTALLER + '/config/walkner-icpo.js'
      },
      {
        expand: true,
        cwd: SRC_CHROME_BIN,
      ...
      {
        src: DEST_SCRIPTS + '/Walkner ICPO.exe',
        dest: DEST_INSTALLER + '/Walkner ICPO.exe'
      },
      {
        src: DEST_SCRIPTS + '/walkner-icpo-uninstall.exe',
        dest: DEST_INSTALLER + '/bin/walkner-icpo-uninstall.exe'
      }
    ]
  }
};
